...
interface ArticleInputAccordionProps {
...
export default function ArticleInputAccordion({
  form,
  handleSetForm,
}: ArticleInputAccordionProps) {
      ...
      <AccordionItem value="article-item" className="rounded-xl shadow-xl">
        ...
        <AccordionContent className="space-y-6 bg-white p-6">
          ...
          <div>
            ...
            <Select onValueChange={(value) => handleSetForm("category", value)}>
            ...
            <Input
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter" && !e.nativeEvent.isComposing) {
                  e.preventDefault();
                  handleSetForm("tags", [...form.tags, e.currentTarget.value]);
